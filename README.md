# My Sustainable Portfolio
A sustainable, static portfolio website built with vanilla HTML, CSS, and JavaScript. Hosted on Cloudflare Pages using 100% renewable energy. Scored 100/100 [Ecograder]([https://pages.github.com/](https://ecograder.com/)) score. \
Link to website: https://gloriat.dev/

## How's It Made
**Tech used:** HTML, CSS, JavaScript \
Originally, I considered making my portfolio using React. However, I've been looking into web sustainablity and decided to create a static web page to reduce energy consumption. \

Other considerations considered for sustainability:
...
3. No Images - Wasn't a necessity and having uncompressed images can onsume more bandwidth and slow down website loading, leading to higher, unnecessary energy consumption. 
